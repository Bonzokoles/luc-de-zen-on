...
async function createWorker(accountId: string, apiToken: string, workerName: string, workerCode: string) {
  try {
...
async function updateWorker(accountId: string, apiToken: string, workerName: string, workerCode: string) {
  try {
    const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${accountId}/workers/scripts/${workerName}`, {
      method: 'PUT',
      headers: {
...
async function deleteWorker(accountId: string, apiToken: string, workerName: string) {
  try {
    const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${accountId}/workers/scripts/${workerName}`, {
      method: 'DELETE',
      headers: {
...
async function addWorkerRoute(accountId: string, apiToken: string, workerName: string, route: string) {
  try {
