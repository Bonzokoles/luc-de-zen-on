...
async function onRequest(context2) {
  const { request, next, env } = context2;
...
__name(handlePerformanceOptimizations, "handlePerformanceOptimizations");
...
__name(shouldSkipMiddleware, "shouldSkipMiddleware");
...
__name(applyCachingStrategy, "applyCachingStrategy");
...
__name(shouldCacheResponse, "shouldCacheResponse");

// ../.wrangler/tmp/pages-j77WVY/functionsRoutes-0.6252418173095537.mjs
var routes = [
  {
    routePath: "/",
    mountPath: "/",
...
// ../node_modules/.pnpm/wrangler@4.37.1_@cloudflare+workers-types@4.20250917.0/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
