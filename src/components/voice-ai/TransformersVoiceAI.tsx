...
export default function TransformersVoiceAI({ className = "" }: TransformersVoiceAIProps) {
    ...
    <div className={`transformers-voice-ai ${className}`}>
      ...
      <div className="voice-controls">
        ...
        <div className="status-info">
          {isLoading && <span className="loading">⏳ Ładowanie modelu SpeechT5...</span>}
          {isModelLoaded && !isLoading && <span className="ready">✅ Model gotowy</span>}
