...
=======
    ...
    window.addEventListener(
      "cyber-music-analyser-ready",
      handleVisualizerReady
    );
    window.addEventListener("music-analyser-ready", handleVisualizerReady);
...
=======
  ...
  function toggleVisualizerCycle() {
    if (typeof window !== "undefined" && window.toggleVisualizerCycle) {
      window.toggleVisualizerCycle();
    } else {
      console.warn("Visualizer cycle controls not available yet");
    }
>>>>>>> c1c4ac5534f2943dcdcdd273d347cf64339cc1a7
  }
...
=======
  // Global API - compatible with main page
  if (typeof window !== "undefined") {
    window.MUSIC = {
      ...
      <div class="panel-loading">
        <div class="loading-message">
          ...
          <div class="loading-subtext">
            Przycisk zostanie odbloqkowany po uruchomieniu
          </div>
          <div class="loading-dots">
            <span>●</span><span>●</span><span>●</span>
          </div>
    ...
    {:else if !isMinimized}
      <div class="panel-content">
        ...
        <div class="player-controls">
          ...
          <button class="control-btn" on:click={togglePlaylist}>📋</button>
          <button
            class="control-btn visualizer-btn"
            title="Przełącz sekwencyjne wizualizatory"
            on:click={toggleVisualizerCycle}>🌊</button
          >
        </div>
    ...
    <div class="playlist-panel">
      ...
      <div class="playlist-actions">
        ...
        <button
          class="action-btn"
          on:click={() =>
            document.getElementById("music-folder-revived").click()}
        >
          📁 Load Folder
        </button>
