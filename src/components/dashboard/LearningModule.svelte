<script>
  ...
  const allAchievements = [
    { name: "Pierwszy Krok", threshold: 1, icon: "M12 4.5v15m7.5-7.5h-15" }, // Plus icon
    {
      name: "Młody Adept",
      threshold: 5,
      icon: "M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-2.178-2.178m2.178 2.178l2.178 2.178m15.482-2.178l2.178-2.178m-2.178 2.178l-2.178 2.178m0 0l-2.178 2.178m2.178-2.178l2.178-2.178",
    }, // Academic cap icon
    {
      name: "Mistrz Konwersacji",
      threshold: 15,
      icon: "M8.25 7.5l.415-.207a.75.75 0 011.085.707v5.362a.75.75 0 01-1.085.707l-.415-.207M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
    }, // Chat bubble icon
    {
      name: "Cyfrowy Mentor",
      threshold: 30,
      icon: "M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.324h5.383c.494 0 .693.658.328.988l-4.355 3.18a.563.563 0 00-.182.623l1.634 4.83c.148.44-.372.824-.764.55l-4.355-3.18a.563.563 0 00-.652 0l-4.355 3.18c-.392.274-.912-.11-.764-.55l1.634-4.83a.563.563 0 00-.182-.623L2.39 9.92c-.365-.33-.166-.988.328-.988h5.383a.563.563 0 00.475-.324L11.48 3.5z",
    }, // Star icon
  ];

  $: unlockedAchievements = allAchievements.filter(
    (a) => intelligenceLevel >= a.threshold
  );
...
<div
  class="bg-cyber-surface border border-cyber-border rounded-none p-6 font-mono h-full flex flex-col"
>
  <h3 class="font-bold text-lg text-cyber-blue mb-4">
    ROZWÓJ INTELIGENCJI BIELIKA
  </h3>

  <div class="mb-4">
    <div
      class="flex justify-between items-center text-xs text-cyber-text-dim mb-1"
    >
    ...
    <div class="w-full bg-cyber-dark border border-cyber-border/50 h-4 p-0.5">
      <div
        class="bg-cyber-blue h-full transition-all duration-500"
      ...
      {#each allAchievements as achievement}
        ...
        >
          <div
            ...
            class:border-cyber-border={intelligenceLevel <
          ...
          >
            <svg
              ...
              class:text-cyber-text-dim={intelligenceLevel <
                achievement.threshold}
            >
              <path
  ...
  <h4 class="text-cyber-text-dim mt-4 mb-2 text-xs uppercase">
    Historia Rozwoju
  </h4>
