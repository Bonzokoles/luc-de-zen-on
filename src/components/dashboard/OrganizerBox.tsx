...
const OrganizerBox = () => {
  ...
  return (
    <div className="relative z-10">
      <div
        className={`bg-gradient-to-br from-green-900/50 to-teal-900/50 border-2 border-green-500/30 rounded-lg overflow-hidden transition-all duration-500 ease-out ${
