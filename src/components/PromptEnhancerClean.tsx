...
const PromptEnhancer: React.FC<PromptEnhancerProps> = ({ onEnhance, initialPrompt = '' }) => {
    ...
    const colorPalettes = ['cyberpunk', 'vintage', 'monochrome', 'pastel', 'vibrant', 'earth', 'ocean', 'sunset', 'forest', 'cosmic'];
    const moods = ['dramatic', 'peaceful', 'mysterious', 'energetic', 'romantic', 'futuristic', 'vintage', 'dark', 'bright', 'surreal'];
    const mediaTypes = ['Oil Painting', 'Watercolor', 'Digital Art', 'Photography', 'Pencil Drawing', 'Concept Art', 'Street Art', 'Sculpture'];
            ...
            <div style={styles.optionsGrid}>
                <div style={styles.optionGroup}>
                    ...
                    <input
                        ...
                        onChange={(e) => setOptions(prev => ({ ...prev, artistStyle: e.target.value }))}
                    ...
                    <div style={styles.artistTags}>
                        {popularArtists.map(artist => (
                            <span
                                ...
                                onClick={() => setOptions(prev => ({ ...prev, artistStyle: artist }))}
                            >
                                {artist}
                            </span>
                        ))}
                ...
                <div style={styles.optionGroup}>
                    ...
                    <select
                        ...
                        onChange={(e) => setOptions(prev => ({ ...prev, mediaType: e.target.value }))}
                    >
                ...
                <div style={styles.optionGroup}>
                    ...
                    <select
                        ...
                        onChange={(e) => setOptions(prev => ({ ...prev, quality: e.target.value as 'standard' | 'high' | 'ultra' }))}
                    >
                    ...
                    <div style={styles.checkboxWrapper}>
                        <input
                            ...
                            onChange={(e) => setOptions(prev => ({ ...prev, enhanceCreativity: e.target.checked }))}
                        />
            ...
            {result && (
                <div style={styles.resultSection}>
                    ...
                    <div style={styles.resultBlock}>
                        ...
                        <div style={{ ...styles.resultText, ...styles.enhancedText }}>{result.enhanced}</div>
                        <button
                    ...
                    <div style={styles.resultBlock}>
                        ...
                        <div style={{ ...styles.resultText, ...styles.negativeText }}>{result.negativePrompt}</div>
                        <button
                            style={styles.copyButton}
                    ...
                    {result.artistRecommendations && result.artistRecommendations.length > 0 && (
                        <div>
                    ...
                    {result.stats && (
                        <div style={styles.stats}>
                            <div style={styles.statItem}>
                                <div style={styles.statValue}>{result.stats.originalLength}</div>
                                <div style={styles.statLabel}>Original Length</div>
                            </div>
                            <div style={styles.statItem}>
                                <div style={styles.statValue}>{result.stats.enhancedLength}</div>
