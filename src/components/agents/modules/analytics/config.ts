...
export const AGENT_CONFIG = {
  ...
  polishMarket: {
    ...
    paymentMethods: {
      ...
      card: { market_share: 0.4, growth_rate: 0.05 },
      transfer: { market_share: 0.2, growth_rate: -0.05 },
      cod: { market_share: 0.05, growth_rate: -0.1 },
    },

    demographics: {
      age_groups: {
        "18_24": { share: 0.15, digital_adoption: 0.95 },
        "25_34": { share: 0.25, digital_adoption: 0.9 },
        "35_44": { share: 0.2, digital_adoption: 0.85 },
        "45_54": { share: 0.2, digital_adoption: 0.75 },
        "55_plus": { share: 0.2, digital_adoption: 0.6 },
      },

      regions: {
        mazowieckie: { share: 0.17, gdp_per_capita: "high" },
        slaskie: { share: 0.13, gdp_per_capita: "medium" },
        wielkopolskie: { share: 0.1, gdp_per_capita: "high" },
