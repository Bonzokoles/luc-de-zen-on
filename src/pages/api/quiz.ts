...
export const POST: APIRoute = async ({ request, locals }) => {
  try {
    ...
    const systemPrompt = `You are an expert at creating educational quizzes. Create a quiz on the topic of "${topic}" at the "${difficultyLevels[difficulty as keyof typeof difficultyLevels]}" level. You must generate exactly ${questionCount} questions. You must respond with a valid JSON object only.`;
