...
const WORKERS: WorkerConfig[] = [
    { name: 'AI Bot Worker', url: '/api/ai-bot-worker', endpoint: '/api/chat', timeout: 5000 },
    { name: 'Generate Image', url: '/api/generate-image', endpoint: '/api/generate-image', timeout: 10000 },
    { name: 'FAQ Generator', url: '/api/faq-generator', endpoint: '/api/faq-generator', timeout: 5000 },
    { name: 'Voice Avatar', url: '/api/voice-avatar', endpoint: '/api/voice-handler', timeout: 8000 },
    { name: 'Marketing Content', url: '/api/generate-marketing-content', endpoint: '/api/generate-marketing-content', timeout: 5000 },
    { name: 'Recommendations', url: '/api/get-recommendations', endpoint: '/api/get-recommendations', timeout: 5000 },
    { name: 'Education Recommendations', url: '/api/education-recommendations', endpoint: '/api/education-recommendations', timeout: 5000 },
    { name: 'Quiz Generator', url: '/api/quiz', endpoint: '/api/quiz', timeout: 5000 },
    { name: 'Reminders', url: '/api/reminders', endpoint: '/api/reminders', timeout: 3000 },
    { name: 'Ticket System', url: '/api/tickets', endpoint: '/api/tickets', timeout: 3000 }
];
...
async function testWorkerEndpoint(worker: WorkerConfig): Promise<Partial<WorkerStatus>> {
...
async function getWorkerMetrics(workerName: string): Promise<Partial<WorkerStatus>> {
