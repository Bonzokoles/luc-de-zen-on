...
export const POST: APIRoute = async ({ request, locals }) => {
  try {
    const { topic, category, length, tone, instructions } =
        ...
        messages: [
          {
            role: "system",
            content:
              "Jesteś ekspertem w tworzeniu wysokiej jakości treści blogowych. Tworzysz angażujące, wartościowe i zoptymalizowane pod SEO artykuły w języku polskim.",
          },
          {
            role: "user",
            content: prompt,
