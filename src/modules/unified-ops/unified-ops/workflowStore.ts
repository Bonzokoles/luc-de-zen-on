    ...
    immer((set, get) => ({
        ...
        executeWorkflow: async () => {
            ...
            try {
                ...
                const data = await response.json() as { success: boolean; error?: string; results?: Record<string, unknown> }
                ...
                Object.entries(data.results ?? {}).forEach(([nodeId, result]: [string, unknown]) => {
