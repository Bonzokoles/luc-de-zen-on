...
export async function testChatAPI() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      return {
        success: false,
        message: result.error || "Chat API test failed",
      };
    }
  } catch (error) {
...
export async function testAIBot(message: string = "Test message") {
  ...
  try {
    ...
    if (response.ok) {
      ...
      return {
        success: true,
        message: "AI Bot API is working correctly",
        data: result,
      };
    } else {
      ...
      return {
        success: false,
        message: result.error || "AI Bot API test failed",
      };
    }
  } catch (error) {
...
export async function testImageGeneration(
  prompt: string = "beautiful landscape"
) {
  ...
  try {
    ...
    if (response.ok) {
      ...
      return {
        success: true,
        message: "Image Generation API is working correctly",
        data: result,
      };
    } else {
      ...
      return {
        success: false,
        message: result.error || "Image Generation API test failed",
      };
    }
  } catch (error) {
...
export async function testKaggleAPI(search: string = "machine learning") {
  ...
  try {
    ...
    if (response.ok) {
      ...
      return {
        success: true,
        message: "Kaggle API is working correctly",
        data: result,
      };
    } else {
      ...
      return {
        success: false,
        message: result.error || "Kaggle API test failed",
      };
    }
  } catch (error) {
...
export async function testTavilyAPI(query: string = "AI technology") {
  ...
  try {
    ...
    if (response.ok) {
      ...
      return {
        success: false,
        message: result.error || "Tavily API test failed",
      };
    }
  } catch (error) {
