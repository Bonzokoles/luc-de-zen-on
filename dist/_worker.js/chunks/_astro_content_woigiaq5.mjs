...
import { ap as objectType, aq as dateType, ar as numberType, as as arrayType, at as stringType, A as AstroError, au as UnknownContentCollectionError, c as createComponent, av as RenderUndefinedEntryError, am as unescapeHTML, a as renderTemplate, k as escape, aw as renderUniqueStylesheet, ax as renderScriptElement, ay as createHeadAndContent, r as renderComponent } from './astro/server_BDhFni3J.mjs';
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_Oj0iLohx.mjs';
import { b as VALID_INPUT_FORMATS } from './consts_C49WwYgi.mjs';
import { u as unflatten } from './parse_CQ4khCC6.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BWpH26or.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_twNce0_U.mjs').then(n => n._);
