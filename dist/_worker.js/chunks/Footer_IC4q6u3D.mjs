...
import { e as createAstro, c as createComponent, h as addAttribute, r as renderComponent, z as $$ClientRouter, a as renderTemplate, A as twMerge, B as clsx, m as maybeRenderHead, p as push, k as pop } from './vendor_QZhDtzeH.mjs';
/* empty css                            */
import { s as siteTitle } from './site_efiYLszo.mjs';
import { $ as $$Section } from './Section_CnYp-Sd_.mjs';
...
function Menu($$payload, $$props) {
	...
	$$payload.out += `<button class="ml-auto my-auto cursor-pointer hover:brightness-125 md:hidden" aria-label="Drop Down Menu"><svg class="w-8 h-8 stroke-accent" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 5H21 M3 12H21 M3 19H21" stroke-linecap="round" stroke-linejoin="round"></path></svg></button> `;
...
export { $$Head as $, $$Header as a, $$Footer as b, $$CosmeticText as c };
