...
import { e as createAstro, c as createComponent, g as addAttribute, b as renderScript, a as renderTemplate, r as renderComponent, m as maybeRenderHead, an as renderSlot, i as clsx } from './astro/server_BDhFni3J.mjs';
/* empty css                            */
import { s as siteTitle } from './site_BkxpWSbL.mjs';

const $$Astro$5 = createAstro("https://mybonzo.com");
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$5, $$props, $$slots);
  Astro2.self = $$ClientRouter;
  const { fallback = "animate" } = Astro2.props;
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "Q:/mybonzo/luc-de-zen-on/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "Q:/mybonzo/luc-de-zen-on/node_modules/astro/components/ClientRouter.astro", void 0);
...
function Menu($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<button class="ml-auto my-auto cursor-pointer hover:brightness-125 md:hidden" aria-label="Drop Down Menu"><svg class="w-8 h-8 stroke-accent" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 5H21 M3 12H21 M3 19H21" stroke-linecap="round" stroke-linejoin="round"></path></svg></button> `);
...
export { $$Section as $, $$Footer as a, $$Header as b, $$Head as c, $$CosmeticText as d };
