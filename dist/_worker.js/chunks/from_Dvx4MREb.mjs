...
import { r as requireBuffer } from './index_WpCgqMdc.mjs';
...
const _File = class File2 extends Blob {
  #lastModified = 0;
  #name = "";
  /**
   * @param {*[]} fileBits
...
function formDataToBlob(F2, B = Blob) {
...
export { Blob as B, FormData as F, File as a, dataUriToBuffer as d, formDataToBlob as f };
