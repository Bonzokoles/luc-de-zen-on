...
import { F as FormData, f as formDataToBlob, B as Blob, d as dataUriToBuffer } from './from_Dvx4MREb.mjs';
export { a as File } from './from_Dvx4MREb.mjs';
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await import('./multipart-parser_esk22_pq.mjs');
...
export { AbortError, Blob, FetchError, FormData, Headers, Request, Response, fetch as default, isRedirect };
