...
import { n as attr, i as ensure_array_like, k as escape_html } from './vendor_DlPT8CWO.mjs';
/* empty css                                       */
...
function LeadQualificationForm($$renderer) {
	...
	$$renderer.push(`<div class="worker-card bg-black border border-cyan-500/30 p-6 rounded-lg shadow-2xl svelte-1marw4p"><div class="mb-6"><h2 class="text-2xl font-bold text-cyan-300 mb-2 uppercase tracking-wider">Automatyzacja obsługi klienta</h2> <p class="text-gray-400">Inteligentny system kwalifikacji leadów z automatyczną odpowiedzią AI</p></div> <div class="space-y-4"><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div><label for="name" class="block text-cyan-300 font-medium mb-2 uppercase text-sm tracking-wide">Imię i nazwisko *</label> <input id="name"${attr('value', name)} placeholder="Jan Kowalski" required class="w-full p-3 bg-white border border-gray-600/50 rounded-lg text-black placeholder-gray-500 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 font-mono"/></div> <div><label for="email" class="block text-cyan-300 font-medium mb-2 uppercase text-sm tracking-wide">E-mail *</label> <input id="email" type="email"${attr('value', email)} placeholder="jan@example.com" required class="w-full p-3 bg-white border border-gray-600/50 rounded-lg text-black placeholder-gray-500 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 font-mono"/></div></div> <div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div><label for="phone" class="block text-cyan-300 font-medium mb-2 uppercase text-sm tracking-wide">Telefon</label> <input id="phone"${attr('value', phone)} placeholder="+48 123 456 789" class="w-full p-3 bg-white border border-gray-600/50 rounded-lg text-black placeholder-gray-500 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 font-mono"/></div> <div><label for="company" class="block text-cyan-300 font-medium mb-2 uppercase text-sm tracking-wide">Firma</label> <input id="company"${attr('value', company)} placeholder="Nazwa firmy" class="w-full p-3 bg-white border border-gray-600/50 rounded-lg text-black placeholder-gray-500 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 font-mono"/></div></div> <div><label for="budget" class="block text-cyan-300 font-medium mb-2 uppercase text-sm tracking-wide">Budżet projektu</label> `);
