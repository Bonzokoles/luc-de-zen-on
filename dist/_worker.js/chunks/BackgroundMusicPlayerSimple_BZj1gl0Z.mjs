...
import { c as createComponent, m as maybeRenderHead, h as addAttribute, a as renderTemplate, z as onDestroy, j as attr_class, k as escape_html, i as ensure_array_like, n as attr, A as attr_style, l as stringify } from './vendor_DlPT8CWO.mjs';
/* empty css                         */
...
function AiHelpAssistant($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="assistant-container svelte-et2eqj"><div class="assistant-panel svelte-et2eqj"><div class="assistant-header svelte-et2eqj"><div class="flex items-center gap-2 svelte-et2eqj"><span class="text-lg svelte-et2eqj">🤖</span> <span class="font-medium svelte-et2eqj">POLACZEK_T Asystent</span></div> <div class="flex items-center gap-2 svelte-et2eqj"><span${attr_class(
      ...
      `text-xs ${getStatusColor(agentStatus)}`,
      "svelte-et2eqj"
    )}>${escape_html(getStatusIcon(agentStatus))}
          ${escape_html(agentStatus)}</span></div></div> <div class="messages svelte-et2eqj"><!--[-->`);
...
function BackgroundMusicPlayerSimple($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div class="background-music-player in-flow svelte-u12wbg"><audio preload="metadata" crossorigin="anonymous"></audio> <div class="music-control-panel svelte-u12wbg"><div class="panel-header svelte-u12wbg"><span>🎵 MUSIC • POLACZEK</span></div> <div class="panel-content svelte-u12wbg"><div class="now-playing svelte-u12wbg"><div class="track-info svelte-u12wbg"><div class="track-name svelte-u12wbg">${escape_html(trackName)}</div> <div class="track-time svelte-u12wbg">${escape_html(formatTime(currentTime))} / ${escape_html(formatTime(duration))}</div></div></div> <div class="player-controls svelte-u12wbg"><button class="control-btn svelte-u12wbg">⏮</button> <button class="control-btn play-pause svelte-u12wbg">${escape_html("▶")}</button> <button class="control-btn svelte-u12wbg">⏭</button> <button${attr_class('control-btn svelte-u12wbg', void 0, { 'active': showPlaylist })}>${escape_html("📋")}</button></div> <div class="volume-control svelte-u12wbg"><span class="svelte-u12wbg">🔊</span> <input type="range" min="0" max="100"${attr('value', volume * 100)} class="volume-slider svelte-u12wbg"/></div> <div class="progress-container svelte-u12wbg"><div class="progress-bar svelte-u12wbg" role="slider" tabindex="0" aria-label="Seek"${attr('aria-valuemin', 0)}${attr('aria-valuemax', 0)}${attr('aria-valuenow', 0)}><div class="progress-fill svelte-u12wbg"${attr_style(`width: ${stringify(0)}%`)}></div></div></div> `);
