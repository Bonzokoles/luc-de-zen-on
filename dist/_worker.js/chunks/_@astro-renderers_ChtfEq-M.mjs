...
import { h as getDefaultExportFromCjs, i as clsx$1 } from './astro/server_BDhFni3J.mjs';
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
  ...
  if (children && opts.experimentalReactChildren) {
    ...
    const convert = await import('./vnode-children_BMhnWkGg.mjs').then((mod) => mod.default);
...
export { reactExports as a, attr as b, ensure_array_like as c, attr_class as d, escape_html as e, ssr_context as f, attr_style as g, slot as h, bind_props as i, store_get as j, noop as n, renderers as r, stringify as s, unsubscribe_stores as u };
