...
FunkcjonalnoĹ›ci
</h3> <ul class="space-y-2 text-[#e0e0e0] font-['Kenyan_Coffee']" data-astro-cid-6sce2xus> <li class="flex items-center gap-2" data-astro-cid-6sce2xus> <span class="text-[#00ffff]" data-astro-cid-6sce2xus>âś“</span>
Tworzenie quizĂłw wielokrotnego wyboru
</li> <li class="flex items-center gap-2" data-astro-cid-6sce2xus> <span class="text-[#00ffff]" data-astro-cid-6sce2xus>âś“</span>
...
Analiza wynikĂłw i raportowanie
...
MoĹĽliwoĹ›ci AI
</h3> <ul class="space-y-2 text-[#e0e0e0] font-['Kenyan_Coffee']" data-astro-cid-6sce2xus> <li class="flex items-center gap-2" data-astro-cid-6sce2xus> <span class="text-[#00ffff]" data-astro-cid-6sce2xus>âšˇ</span>
Adaptacyjny poziom trudnoĹ›ci
</li> <li class="flex items-center gap-2" data-astro-cid-6sce2xus> <span class="text-[#00ffff]" data-astro-cid-6sce2xus>âšˇ</span>
...
đź“ť Typy quizĂłw i testĂłw
</h3> <div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-astro-cid-6sce2xus> <div class="p-4 bg-[#111111] border border-[#333333]" data-astro-cid-6sce2xus> <div class="text-2xl mb-2" data-astro-cid-6sce2xus>đź§ </div> <div class="text-lg font-bold text-[#00ffff] mb-2 font-['Neuropol']" data-astro-cid-6sce2xus>
WIEDZA
</div> <p class="text-[#a0a0a0] text-sm font-['Kenyan_Coffee'] mb-3" data-astro-cid-6sce2xus>
Sprawdzanie znajomoĹ›ci faktĂłw, definicji, procedur
...
Profiling preferencji, stylĂłw pracy, motywacji
</p> <div class="text-xs text-[#00ffff]" data-astro-cid-6sce2xus>
...
Analiza znaczenia odpowiedzi, nie tylko sĹ‚Ăłw kluczowych
...
UwzglÄ™dnienie kontekstu i nuansĂłw w odpowiedziach
</p> </div> <div class="p-3 bg-[#00ffff]/10 border border-[#00ffff]/30" data-astro-cid-6sce2xus> <div class="font-bold text-[#00ffff] font-['Neuropol']" data-astro-cid-6sce2xus>
PARTIAL CREDIT
</div> <p class="text-[#a0a0a0] text-sm font-['Kenyan_Coffee']" data-astro-cid-6sce2xus>
...
Wyniki quizĂłw automatycznie aktualizujÄ… profile uczniĂłw i wpĹ‚ywajÄ…
                na rekomendacje kolejnych materiaĹ‚Ăłw edukacyjnych.
...
đź› ď¸Ź Quiz Builder - Tworzenie testĂłw
</h3> <div class="grid grid-cols-1 md:grid-cols-4 gap-4" data-astro-cid-6sce2xus> <div class="text-center p-3 bg-[#00ffff]/10 border border-[#00ffff]/30" data-astro-cid-6sce2xus> <div class="text-2xl mb-2" data-astro-cid-6sce2xus>đź“‹</div> <div class="text-sm font-bold text-[#00ffff] mb-1 font-['Neuropol']" data-astro-cid-6sce2xus>
TEMPLATE
</div> <p class="text-[#a0a0a0] text-xs font-['Kenyan_Coffee']" data-astro-cid-6sce2xus>
Wybierz szablon quizu
</p> </div> <div class="text-center p-3 bg-[#00ffff]/10 border border-[#00ffff]/30" data-astro-cid-6sce2xus> <div class="text-2xl mb-2" data-astro-cid-6sce2xus>âť“</div> <div class="text-sm font-bold text-[#00ffff] mb-1 font-['Neuropol']" data-astro-cid-6sce2xus>
QUESTIONS
</div> <p class="text-[#a0a0a0] text-xs font-['Kenyan_Coffee']" data-astro-cid-6sce2xus>
Dodaj pytania i odpowiedzi
</p> </div> <div class="text-center p-3 bg-[#00ffff]/10 border border-[#00ffff]/30" data-astro-cid-6sce2xus> <div class="text-2xl mb-2" data-astro-cid-6sce2xus>âš™ď¸Ź</div> <div class="text-sm font-bold text-[#00ffff] mb-1 font-['Neuropol']" data-astro-cid-6sce2xus>
SETTINGS
</div> <p class="text-[#a0a0a0] text-xs font-['Kenyan_Coffee']" data-astro-cid-6sce2xus>
Skonfiguruj ocenianie AI
</p> </div> <div class="text-center p-3 bg-[#00ffff]/10 border border-[#00ffff]/30" data-astro-cid-6sce2xus> <div class="text-2xl mb-2" data-astro-cid-6sce2xus>đźš€</div> <div class="text-sm font-bold text-[#00ffff] mb-1 font-['Neuropol']" data-astro-cid-6sce2xus>
DEPLOY
</div> <p class="text-[#a0a0a0] text-xs font-['Kenyan_Coffee']" data-astro-cid-6sce2xus>
