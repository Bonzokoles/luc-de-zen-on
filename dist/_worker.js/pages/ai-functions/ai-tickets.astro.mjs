...
</a> </div> </div> </section> <!-- Main Content --> <section class="relative z-20 py-12" data-astro-cid-6t3e7dfk> <div class="max-w-4xl mx-auto px-4" data-astro-cid-6t3e7dfk> <!-- Ticket Submission Widget --> ${renderComponent($$result2, "TicketSubmissionWidget", TicketSubmissionWidget, { "client:load": true, "client:component-hydration": "load", "client:component-path": "Q:/mybonzo/luc-de-zen-on/src/components/TicketSubmissionWidget.svelte", "client:component-export": "default", "data-astro-cid-6t3e7dfk": true })} <!-- Features Description --> <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6" data-astro-cid-6t3e7dfk> <div class="p-6 bg-[#111111] border border-[#333333] glass-effect" data-astro-cid-6t3e7dfk> <h3 class="text-xl font-bold text-[#00ffff] mb-4 uppercase tracking-wider font-['Neuropol']" data-astro-cid-6t3e7dfk>
FunkcjonalnoĹ›ci
</h3> <ul class="space-y-2 text-[#e0e0e0] font-['Kenyan_Coffee']" data-astro-cid-6t3e7dfk> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âś“</span>
Automatyczna klasyfikacja zgĹ‚oszeĹ„
</li> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âś“</span>
Priorytetyzacja na podstawie pilnoĹ›ci
</li> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âś“</span>
Przypisywanie do odpowiednich zespoĹ‚Ăłw
</li> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âś“</span>
...
MoĹĽliwoĹ›ci AI
</h3> <ul class="space-y-2 text-[#e0e0e0] font-['Kenyan_Coffee']" data-astro-cid-6t3e7dfk> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âšˇ</span>
Analiza sentymentu i pilnoĹ›ci
</li> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âšˇ</span>
Przewidywanie czasu rozwiÄ…zania
</li> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âšˇ</span>
Sugerowanie rozwiÄ…zaĹ„ z bazy wiedzy
</li> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âšˇ</span>
Wykrywanie duplikatĂłw
</li> <li class="flex items-center gap-2" data-astro-cid-6t3e7dfk> <span class="text-[#00ffff]" data-astro-cid-6t3e7dfk>âšˇ</span>
...
đźŽŻ System klasyfikacji
</h3> <div class="grid grid-cols-1 md:grid-cols-4 gap-4" data-astro-cid-6t3e7dfk> <div class="text-center p-4 bg-red-900/30 border border-red-400/50" data-astro-cid-6t3e7dfk> <div class="text-3xl mb-2" data-astro-cid-6t3e7dfk>đźš¨</div> <div class="text-lg font-bold text-red-400 font-['Neuropol']" data-astro-cid-6t3e7dfk>
CRITICAL
</div> <div class="text-xs text-[#a0a0a0] uppercase tracking-wide" data-astro-cid-6t3e7dfk>
System Down
</div> <div class="text-xs text-red-300 mt-1" data-astro-cid-6t3e7dfk>â‰¤ 1h SLA</div> </div> <div class="text-center p-4 bg-orange-900/30 border border-orange-400/50" data-astro-cid-6t3e7dfk> <div class="text-3xl mb-2" data-astro-cid-6t3e7dfk>âš ď¸Ź</div> <div class="text-lg font-bold text-orange-400 font-['Neuropol']" data-astro-cid-6t3e7dfk>
HIGH
</div> <div class="text-xs text-[#a0a0a0] uppercase tracking-wide" data-astro-cid-6t3e7dfk>
Business Impact
</div> <div class="text-xs text-orange-300 mt-1" data-astro-cid-6t3e7dfk>â‰¤ 4h SLA</div> </div> <div class="text-center p-4 bg-yellow-900/30 border border-yellow-400/50" data-astro-cid-6t3e7dfk> <div class="text-3xl mb-2" data-astro-cid-6t3e7dfk>đź“‹</div> <div class="text-lg font-bold text-yellow-400 font-['Neuropol']" data-astro-cid-6t3e7dfk>
MEDIUM
</div> <div class="text-xs text-[#a0a0a0] uppercase tracking-wide" data-astro-cid-6t3e7dfk>
Functionality
</div> <div class="text-xs text-yellow-300 mt-1" data-astro-cid-6t3e7dfk>â‰¤ 24h SLA</div> </div> <div class="text-center p-4 bg-green-900/30 border border-green-400/50" data-astro-cid-6t3e7dfk> <div class="text-3xl mb-2" data-astro-cid-6t3e7dfk>đź’ˇ</div> <div class="text-lg font-bold text-green-400 font-['Neuropol']" data-astro-cid-6t3e7dfk>
LOW
</div> <div class="text-xs text-[#a0a0a0] uppercase tracking-wide" data-astro-cid-6t3e7dfk>
Enhancement
...
đź‘Ą Automatyczne przypisywanie
...
PĹ‚atnoĹ›ci, faktury, zmiany planu
...
đź“Š Statystyki obsĹ‚ugi bÄ™dÄ… wyĹ›wietlane po skonfigurowaniu
                systemu ticketĂłw.
...
đź”— Integracje systemĂłw ticketowych
...
Automatyczne workflow zapewniajÄ… synchronizacjÄ™ ticketĂłw miÄ™dzy wszystkimi
              systemami, powiadomienia email/SMS, eskalacjÄ™ SLA oraz raportowanie
              metryk obsĹ‚ugi klienta.
