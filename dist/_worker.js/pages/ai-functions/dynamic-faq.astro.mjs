...
const $$DynamicFaq = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MyBonzoLayout", $$MyBonzoLayout, { "siteTitle": "Generator FAQ Dynamiczny | AI Functions | KAROL LISSON", "data-astro-cid-upcmgyo4": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "DecorativeLines", $$DecorativeLines, { "data-astro-cid-upcmgyo4": true })} ${maybeRenderHead()}<main class="min-h-svh relative z-10" data-astro-cid-upcmgyo4> <!-- Background Grid Pattern --> <div class="fixed inset-0 bg-[#0a0a0a]" data-astro-cid-upcmgyo4> <div class="absolute inset-0 bg-gradient-to-br from-cyan-900/20 via-black to-black" data-astro-cid-upcmgyo4></div> <div class="cyber-grid absolute inset-0" data-astro-cid-upcmgyo4></div> </div> <!-- Header Section --> <section class="relative z-20 border-b border-[#333333] pt-20" data-astro-cid-upcmgyo4> <div class="max-w-6xl mx-auto px-4 py-8" data-astro-cid-upcmgyo4> <div class="flex items-center justify-between mb-8" data-astro-cid-upcmgyo4> <div data-astro-cid-upcmgyo4> <h1 class="text-4xl md:text-5xl font-bold text-[#00ffff] mb-2 uppercase tracking-wider font-['Neuropol']" data-astro-cid-upcmgyo4>
Generator FAQ Dynamiczny
</h1> <p class="text-[#a0a0a0] text-lg font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>
AI generujący dynamicznie pytania i odpowiedzi na podstawie bazy wiedzy
</p> </div> <div class="text-right text-sm text-[#a0a0a0] font-mono" data-astro-cid-upcmgyo4> <div class="mb-1" data-astro-cid-upcmgyo4>
STATUS: <span class="text-[#00ffff]" data-astro-cid-upcmgyo4>GENERATING</span> </div> <div data-astro-cid-upcmgyo4>FAQ COUNT: <span class="text-[#00ffff] animate-pulse" data-astro-cid-upcmgyo4>1,247</span></div> </div> </div> <!-- Navigation --> <div class="flex gap-4 mb-8" data-astro-cid-upcmgyo4> <a href="/" class="px-4 py-2 bg-[#111111] border border-[#333333] text-[#00ffff] hover:brightness-125 transition-all duration-300 font-['Neuropol'] uppercase tracking-wide text-sm" data-astro-cid-upcmgyo4>
← Powrót do głównej
</a> <a href="/zaawansowane-funkcje-ai" class="px-4 py-2 bg-[#111111] border border-[#333333] text-[#e0e0e0] hover:text-[#00ffff] hover:brightness-125 transition-all duration-300 font-['Neuropol'] uppercase tracking-wide text-sm" data-astro-cid-upcmgyo4>
Wszystkie funkcje AI
</a> </div> </div> </section> <div class="max-w-4xl mx-auto px-4" data-astro-cid-upcmgyo4> <!-- FAQ Generator --> <!-- FAQ Generator Widget --> ${renderComponent($$result2, "FAQGeneratorWidget", FAQGeneratorWidget, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "Q:/mybonzo/mybonzo-github/src/components/FAQGeneratorWidget.svelte", "client:component-export": "default", "data-astro-cid-upcmgyo4": true })} <!-- Generated FAQ Display --> <div class="mt-12 p-6 bg-[#111111] border border-[#333333] glass-effect" data-astro-cid-upcmgyo4> <h3 class="text-xl font-bold text-[#00ffff] mb-4 uppercase tracking-wider font-['Neuropol']" data-astro-cid-upcmgyo4>Wygenerowane FAQ</h3> <div class="space-y-4" data-astro-cid-upcmgyo4> <div class="border-l-4 border-[#00ffff] pl-4" data-astro-cid-upcmgyo4> <h4 class="font-bold text-[#e0e0e0] mb-2 font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>Q: Jak działa system AI MyBonzo?</h4> <p class="text-[#a0a0a0] text-sm font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>
...
</p> </div> <div class="border-l-4 border-[#00ffff] pl-4" data-astro-cid-upcmgyo4> <h4 class="font-bold text-[#e0e0e0] mb-2 font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>Q: Jakie są koszty korzystania z platformy?</h4> <p class="text-[#a0a0a0] text-sm font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>
...
</p> </div> <div class="border-l-4 border-[#00ffff] pl-4" data-astro-cid-upcmgyo4> <h4 class="font-bold text-[#e0e0e0] mb-2 font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>Q: Czy oferujecie wsparcie techniczne?</h4> <p class="text-[#a0a0a0] text-sm font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>
