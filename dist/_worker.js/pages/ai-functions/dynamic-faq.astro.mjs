...
import { F as FAQGeneratorWidget } from '../../chunks/FAQGeneratorWidget_pwNJ2uYL.mjs';
...
</a> </div> </div> </section> <div class="max-w-4xl mx-auto px-4" data-astro-cid-upcmgyo4> <!-- FAQ Generator --> <!-- FAQ Generator Widget --> ${renderComponent($$result2, "FAQGeneratorWidget", FAQGeneratorWidget, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "Q:/mybonzo/luc-de-zen-on/src/components/FAQGeneratorWidget.svelte", "client:component-export": "default", "data-astro-cid-upcmgyo4": true })} <!-- Generated FAQ Display --> <div class="mt-12 p-6 bg-[#111111] border border-[#333333] glass-effect" data-astro-cid-upcmgyo4> <h3 class="text-xl font-bold text-[#00ffff] mb-4 uppercase tracking-wider font-['Neuropol']" data-astro-cid-upcmgyo4>Wygenerowane FAQ</h3> <div class="space-y-4" data-astro-cid-upcmgyo4> <div class="border-l-4 border-[#00ffff] pl-4" data-astro-cid-upcmgyo4> <h4 class="font-bold text-[#e0e0e0] mb-2 font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>Q: Jak działa system AI MyBonzo?</h4> <p class="text-[#a0a0a0] text-sm font-['Kenyan_Coffee']" data-astro-cid-upcmgyo4>
