...
import { k as escape_html, c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead } from '../../chunks/vendor_CYa9XZjz.mjs';
export { d as renderers } from '../../chunks/vendor_CYa9XZjz.mjs';
import { $ as $$MyBonzoLayout } from '../../chunks/MyBonzoLayout_BRvVRBoy.mjs';
/* empty css                                                 */

function RemindersManager($$payload, $$props) {
	$$payload.component(($$payload) => {
		...
		$$payload.push(`<!--]--> <div class="space-y-3 max-h-96 overflow-y-auto custom-scrollbar svelte-1seyal6">`);

		{
			$$payload.push('<!--[-->');
			$$payload.push(`<div class="text-center py-8"><div class="animate-spin w-8 h-8 border-2 border-cyan-400 border-t-transparent rounded-full mx-auto mb-4"></div> <p class="text-gray-400">Ładowanie przypomnień...</p></div>`);
		}
