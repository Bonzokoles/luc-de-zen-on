...
import { p as push, j as escape_html, k as pop, c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead } from '../../chunks/vendor_QZhDtzeH.mjs';
...
function RemindersManager($$payload, $$props) {
	...
	$$payload.out += `<!--]--> <div class="space-y-3 max-h-96 overflow-y-auto custom-scrollbar svelte-1xxtgzr">`;

	{
		$$payload.out += '<!--[-->';
		$$payload.out += `<div class="text-center py-8"><div class="animate-spin w-8 h-8 border-2 border-cyan-400 border-t-transparent rounded-full mx-auto mb-4"></div> <p class="text-gray-400">Ładowanie przypomnień...</p></div>`;
	}
