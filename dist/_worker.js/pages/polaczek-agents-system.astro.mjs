...
import { p as push, i as attr, G as store_get, j as escape_html, H as unsubscribe_stores, k as pop, I as writable, c as createComponent, r as renderComponent, b as renderScript, a as renderTemplate, m as maybeRenderHead } from '../chunks/vendor_QZhDtzeH.mjs';
...
function AgentBuilder($$payload, $$props) {
	...
	$$payload.out += `<div class="agent-builder svelte-1bteepc"><h2 class="svelte-1bteepc">Agent Builder</h2> <form><div class="form-group svelte-1bteepc"><label for="agent-name" class="svelte-1bteepc">Agent Name</label> <input id="agent-name" type="text"${attr('value', store_get($$store_subs ??= {}, '$agent', agent).name)} placeholder="e.g., Customer Support Bot" required class="svelte-1bteepc"></div> <div class="form-group svelte-1bteepc"><label for="agent-description" class="svelte-1bteepc">Agent Description</label> <textarea id="agent-description" placeholder="Describe the agent's purpose and capabilities." class="svelte-1bteepc">`;
	...
	$$payload.out += `</textarea></div> <div class="form-group svelte-1bteepc"><label for="agent-type" class="svelte-1bteepc">Agent Type</label> <select id="agent-type" class="svelte-1bteepc"><option value="chatbot">Chatbot</option><option value="task_automation">Task Automation</option><option value="data_analysis">Data Analysis</option><option value="custom">Custom</option></select></div> <button type="submit" class="btn svelte-1bteepc">Create Agent</button></form></div>`;
