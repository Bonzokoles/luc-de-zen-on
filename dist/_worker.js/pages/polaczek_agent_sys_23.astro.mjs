...
import { e as createAstro, c as createComponent, r as renderComponent, b as renderScript, a as renderTemplate, an as renderSlot, m as maybeRenderHead, g as addAttribute } from '../chunks/astro/server_BDhFni3J.mjs';
...
generacja AI SDK z peĹ‚nÄ… funkcjonalnoĹ›ciÄ….<br data-astro-cid-mwcm4pqh>
TwĂłrz, zarzÄ…dzaj i optymalizuj agentĂłw AI<br data-astro-cid-mwcm4pqh>
dla kaĹĽdego zastosowania biznesowego.
...
Agent Data
<svg style="--rotation: -45deg" class="stroke-primary-foreground inline aspect-square w-3 h-auto fill-transparent rotate-[var(--rotation)]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-astro-cid-mwcm4pqh> <path d="M3 12L21 12M21 12L12.5 3.5M21 12L12.5 20.5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-mwcm4pqh></path> </svg> </a> </div> </div> </div> </div> </section> <!-- Separator Section 1 --> <section class="border border-edge relative" data-astro-cid-mwcm4pqh> <div class="max-w-6xl mx-auto" data-astro-cid-mwcm4pqh> <div class="py-1" data-astro-cid-mwcm4pqh></div> </div> </section> <!-- System Statistics Section --> <section class="border border-edge relative" data-astro-cid-mwcm4pqh> <div class="max-w-6xl mx-auto p-6" data-astro-cid-mwcm4pqh> <h3 class="text-2xl font-bold text-primary-foreground mb-6 text-center" data-astro-cid-mwcm4pqh>System Status - POLACZEK AGENTS</h3> <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6" data-astro-cid-mwcm4pqh> ${renderComponent($$result2, "CyberStatCard", $$CyberStatCard, { "title": "Active Agents", "value": "12", "icon": "\u0111\u017A\xA4\u2013", "color": "success", "trend": "up", "data-astro-cid-mwcm4pqh": true }, { "default": async ($$result3) => renderTemplate`
Online & Ready
` })} ${renderComponent($$result2, "CyberStatCard", $$CyberStatCard, { "title": "CPU Usage", "value": "67", "unit": "%", "icon": "\xE2\u0161\u02C7", "color": "warning", "trend": "stable", "data-astro-cid-mwcm4pqh": true }, { "default": async ($$result3) => renderTemplate`
System Load
` })} ${renderComponent($$result2, "CyberStatCard", $$CyberStatCard, { "title": "Memory", "value": "4.2", "unit": "GB", "icon": "\u0111\u017A\u2019\u013E", "color": "primary", "trend": "up", "data-astro-cid-mwcm4pqh": true }, { "default": async ($$result3) => renderTemplate`
RAM Usage
` })} ${renderComponent($$result2, "CyberStatCard", $$CyberStatCard, { "title": "Requests", "value": "1.2k", "icon": "\u0111\u017A\u201C\u0160", "color": "success", "trend": "up", "data-astro-cid-mwcm4pqh": true }, { "default": async ($$result3) => renderTemplate`
Last 24h
` })} </div> <div class="flex flex-wrap gap-4 justify-center" data-astro-cid-mwcm4pqh> ${renderComponent($$result2, "CyberpunkButton", $$CyberpunkButton, { "href": "/POLACZEK_AGENT_SYS_23/dashboard", "variant": "primary", "size": "lg", "icon": "\u0111\u017A\u017D\u017B", "data-astro-cid-mwcm4pqh": true }, { "default": async ($$result3) => renderTemplate`
Dashboard
` })} ${renderComponent($$result2, "CyberpunkButton", $$CyberpunkButton, { "href": "/POLACZEK_AGENT_SYS_23/agents/create", "variant": "success", "size": "lg", "icon": "\xE2\u017E\u2022", "data-astro-cid-mwcm4pqh": true }, { "default": async ($$result3) => renderTemplate`
Create Agent
` })} ${renderComponent($$result2, "CyberpunkButton", $$CyberpunkButton, { "href": "/POLACZEK_AGENT_SYS_23/api-keys", "variant": "secondary", "size": "lg", "icon": "\u0111\u017A\u201D\u2018", "data-astro-cid-mwcm4pqh": true }, { "default": async ($$result3) => renderTemplate`
API Keys
` })} ${renderComponent($$result2, "CyberpunkButton", $$CyberpunkButton, { "href": "/POLACZEK_AGENT_SYS_23/monitoring", "variant": "danger", "size": "lg", "icon": "\u0111\u017A\u201D\u0164", "data-astro-cid-mwcm4pqh": true }, { "default": async ($$result3) => renderTemplate`
Monitoring
` })} </div> </div> </section> <!-- Main POLACZEK SDK Section --> <section class="border border-edge ai-workers-section flex items-center justify-center py-16 relative" id="polaczek-sdk" data-astro-cid-mwcm4pqh> <div class="max-w-6xl mx-auto w-full" data-astro-cid-mwcm4pqh> <div class="section-container" data-astro-cid-mwcm4pqh> <h2 class="system-title" data-astro-cid-mwcm4pqh>POLACZEK AGENTS SYS_23</h2> <!-- Separator after title --> <div style="
          ...
          " data-astro-cid-mwcm4pqh></div> <p class="section-description" style="
            ...
            padding: 0 15px;
          " data-astro-cid-mwcm4pqh>
Kompletne SDK do tworzenia, zarzÄ…dzania i optymalizacji agentĂłw AI. 
            Zaawansowane funkcje wyszukiwania, analizy, generowania treĹ›ci i personalizacji 
            zintegrowane z bazÄ… wiedzy MyBonzo.
</p> <!-- SDK Functions Grid --> <div class="sdk-functions-grid" data-astro-cid-mwcm4pqh> <h3 class="functions-title" data-astro-cid-mwcm4pqh>ZAAWANSOWANE FUNKCJE SDK</h3> <div class="functions-grid" data-astro-cid-mwcm4pqh> <!-- Chat Function --> <div class="function-card" data-function="chat" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>đź’¬</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Chat</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>Standardowa konwersacja AI z kontekstem MyBonzo</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="testSDKFunction('chat')" class="test-btn" data-astro-cid-mwcm4pqh>Test</button> <button onclick="window.open('/POLACZEK_AGENT_SYS_23/dashboard', '_blank')" class="docs-btn" data-astro-cid-mwcm4pqh>Dashboard</button> </div> </div> <!-- Search Function --> <div class="function-card" data-function="search" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>đź”Ť</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Search</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>Zaawansowane wyszukiwanie w bazie wiedzy MyBonzo</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="testSDKFunction('search')" class="test-btn" data-astro-cid-mwcm4pqh>Test</button> <button onclick="viewSDKDocs('search')" class="docs-btn" data-astro-cid-mwcm4pqh>Docs</button> </div> </div> <!-- Analyze Function --> <div class="function-card" data-function="analyze" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>đź“Š</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Analyze</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>GĹ‚Ä™boka analiza tekstu i danych z AI insights</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="testSDKFunction('analyze')" class="test-btn" data-astro-cid-mwcm4pqh>Test</button> <button onclick="viewSDKDocs('analyze')" class="docs-btn" data-astro-cid-mwcm4pqh>Docs</button> </div> </div> <!-- Generate Function --> <div class="function-card" data-function="generate" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>âś¨</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Generate</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>Generowanie treĹ›ci, raportĂłw i materiaĹ‚Ăłw</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="testSDKFunction('generate')" class="test-btn" data-astro-cid-mwcm4pqh>Test</button> <button onclick="viewSDKDocs('generate')" class="docs-btn" data-astro-cid-mwcm4pqh>Docs</button> </div> </div> <!-- Recommend Function --> <div class="function-card" data-function="recommend" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>đźŽŻ</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Recommend</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>Personalizowane rekomendacje i sugestie</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="testSDKFunction('recommend')" class="test-btn" data-astro-cid-mwcm4pqh>Test</button> <button onclick="viewSDKDocs('recommend')" class="docs-btn" data-astro-cid-mwcm4pqh>Docs</button> </div> </div> <!-- Translate Function --> <div class="function-card" data-function="translate" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>đźŚŤ</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Translate</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>Kontekstowe tĹ‚umaczenie miÄ™dzy jÄ™zykami</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="testSDKFunction('translate')" class="test-btn" data-astro-cid-mwcm4pqh>Test</button> <button onclick="viewSDKDocs('translate')" class="docs-btn" data-astro-cid-mwcm4pqh>Docs</button> </div> </div> <!-- Summarize Function --> <div class="function-card" data-function="summarize" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>đź“ť</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Summarize</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>Inteligentne streszczanie dĹ‚ugich treĹ›ci</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="testSDKFunction('summarize')" class="test-btn" data-astro-cid-mwcm4pqh>Test</button> <button onclick="viewSDKDocs('summarize')" class="docs-btn" data-astro-cid-mwcm4pqh>Docs</button> </div> </div> <!-- Agent Create Function --> <div class="function-card" data-function="agent_create" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>đź¤–</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Agent Create</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>Tworzenie niestandardowych agentĂłw AI</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="window.open('/POLACZEK_AGENT_SYS_23/agents/create', '_blank')" class="test-btn" data-astro-cid-mwcm4pqh>Create</button> <button onclick="window.open('/POLACZEK_AGENT_SYS_23/dashboard', '_blank')" class="docs-btn" data-astro-cid-mwcm4pqh>Dashboard</button> </div> </div> <!-- Agent Manage Function --> <div class="function-card" data-function="agent_manage" data-astro-cid-mwcm4pqh> <div class="function-icon" data-astro-cid-mwcm4pqh>âš™ď¸Ź</div> <h4 class="function-name" data-astro-cid-mwcm4pqh>Agent Manage</h4> <p class="function-desc" data-astro-cid-mwcm4pqh>ZarzÄ…dzanie i konfiguracja agentĂłw</p> <div class="function-actions" data-astro-cid-mwcm4pqh> <button onclick="window.open('/POLACZEK_AGENT_SYS_23/dashboard', '_blank')" class="test-btn" data-astro-cid-mwcm4pqh>Dashboard</button> <button onclick="window.open('/POLACZEK_AGENT_SYS_23/agents/create', '_blank')" class="docs-btn" data-astro-cid-mwcm4pqh>Create</button> </div> </div> </div> </div> <!-- SDK Testing Interface --> <div class="sdk-tester-section" data-astro-cid-mwcm4pqh> <h3 class="tester-title" data-astro-cid-mwcm4pqh>LIVE SDK TESTER</h3> <div class="tester-container" data-astro-cid-mwcm4pqh> <div class="tester-controls" data-astro-cid-mwcm4pqh> <div class="control-group" data-astro-cid-mwcm4pqh> <label data-astro-cid-mwcm4pqh>Funkcja SDK:</label> <select id="sdkFunction" class="sdk-select" data-astro-cid-mwcm4pqh> <option value="chat" data-astro-cid-mwcm4pqh>Chat - Standardowa konwersacja</option> <option value="search" data-astro-cid-mwcm4pqh>Search - Wyszukiwanie</option> <option value="analyze" data-astro-cid-mwcm4pqh>Analyze - Analiza</option> <option value="generate" data-astro-cid-mwcm4pqh>Generate - Generowanie</option> <option value="recommend" data-astro-cid-mwcm4pqh>Recommend - Rekomendacje</option> <option value="translate" data-astro-cid-mwcm4pqh>Translate - TĹ‚umaczenie</option> <option value="summarize" data-astro-cid-mwcm4pqh>Summarize - Streszczanie</option> <option value="agent_create" data-astro-cid-mwcm4pqh>Agent Create - Tworzenie agenta</option> <option value="agent_manage" data-astro-cid-mwcm4pqh>Agent Manage - ZarzÄ…dzanie</option> </select> </div> <div class="control-group" data-astro-cid-mwcm4pqh> <label data-astro-cid-mwcm4pqh>Model AI:</label> <select id="sdkModel" class="sdk-select" data-astro-cid-mwcm4pqh> <option value="qwen" data-astro-cid-mwcm4pqh>Qwen 1.5 7B (Rekomendowany)</option> <option value="gemma" data-astro-cid-mwcm4pqh>Gemma 7B (Multilingual)</option> <option value="fast" data-astro-cid-mwcm4pqh>Qwen 0.5B (Szybki)</option> <option value="advanced" data-astro-cid-mwcm4pqh>Llama 3.3 70B (Zaawansowany)</option> <option value="claude" data-astro-cid-mwcm4pqh>Claude 3 Haiku (Kreatywny)</option> </select> </div> </div> <div class="tester-input" data-astro-cid-mwcm4pqh> <textarea id="sdkPrompt" placeholder="WprowadĹş zapytanie do przetestowania SDK..." class="sdk-textarea" data-astro-cid-mwcm4pqh></textarea> <div class="tester-actions" data-astro-cid-mwcm4pqh> <button onclick="executeSDKTest()" class="execute-btn" data-astro-cid-mwcm4pqh>Wykonaj Test SDK</button> <button onclick="clearSDKTest()" class="clear-btn" data-astro-cid-mwcm4pqh>WyczyĹ›Ä‡</button> </div> </div> <div class="tester-output" id="sdkOutput" data-astro-cid-mwcm4pqh> <div class="output-placeholder" data-astro-cid-mwcm4pqh>Wyniki testĂłw SDK pojawiÄ… siÄ™ tutaj...</div> </div> </div> </div> <!-- Quick Actions Section --> <div class="quick-actions-section" data-astro-cid-mwcm4pqh> <h3 class="actions-title" data-astro-cid-mwcm4pqh>SZYBKIE AKCJE</h3> <div class="actions-grid" data-astro-cid-mwcm4pqh> <div class="action-card" data-astro-cid-mwcm4pqh> <h4 data-astro-cid-mwcm4pqh>ďż˝ API Keys Manager</h4> <p data-astro-cid-mwcm4pqh>ZarzÄ…dzanie kluczami zewnÄ™trznych API</p> <button onclick="window.open('/POLACZEK_AGENT_SYS_23/api-keys', '_blank')" class="action-btn" data-astro-cid-mwcm4pqh>
OtwĂłrz Manager
</button> </div> <div class="action-card" data-astro-cid-mwcm4pqh> <h4 data-astro-cid-mwcm4pqh>ďż˝ Agent Data Manager</h4> <p data-astro-cid-mwcm4pqh>Dodawaj wĹ‚asne treĹ›ci i dane do agentĂłw</p> <button onclick="window.open('/POLACZEK_AGENT_SYS_23/agent-data1', '_blank')" class="action-btn" data-astro-cid-mwcm4pqh>
OtwĂłrz Manager
</button> </div> <div class="action-card" data-astro-cid-mwcm4pqh> <h4 data-astro-cid-mwcm4pqh>đź“Š Monitoring</h4> <p data-astro-cid-mwcm4pqh>Status i analityka wszystkich agentĂłw</p> <button onclick="window.open('/POLACZEK_AGENT_SYS_23/dashboard', '_blank')" class="action-btn" data-astro-cid-mwcm4pqh>
OtwĂłrz Monitor
