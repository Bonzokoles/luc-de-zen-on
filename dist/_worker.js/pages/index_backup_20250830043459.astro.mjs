...
import { p as push, l as ensure_array_like, k as pop, c as createComponent, m as maybeRenderHead, b as renderScript, a as renderTemplate, r as renderComponent } from '../chunks/vendor_QZhDtzeH.mjs';
export { d as renderers } from '../chunks/vendor_QZhDtzeH.mjs';
import { $ as $$Layout } from '../chunks/Layout_Bj4fw-c2.mjs';
import { $ as $$Section } from '../chunks/Section_CnYp-Sd_.mjs';
import { c as $$CosmeticText } from '../chunks/Footer_IC4q6u3D.mjs';
/* empty css                                                       */
import { S as SiteDescription, s as siteTitle } from '../chunks/site_efiYLszo.mjs';
import { g as getCollection } from '../chunks/_astro_content_Dn8WcgSO.mjs';

function Tags($$payload, $$props) {
	push();
	const { tags } = $$props;

	function tag($$payload, title) {
		{
			$$payload.out += '<!--[!-->';
		}
	...
	$$payload.out += `<div class="flex flex-row flex-wrap justify-center gap-2 mt-4 text-lg"><!--[-->`;
