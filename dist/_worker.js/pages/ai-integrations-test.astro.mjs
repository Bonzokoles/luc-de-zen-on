...
\u{1F527} Test Connections
</button> </div> <div id="deepseekResults" class="mt-4 p-4 bg-gray-50 rounded-lg hidden" data-astro-cid-mluvns3u> <h3 class="font-semibold mb-2" data-astro-cid-mluvns3u>Analysis Results:</h3> <div id="deepseekContent" data-astro-cid-mluvns3u></div> </div> </div> <!-- Quick Actions --> <div class="bg-white rounded-lg shadow-lg p-6 card-hover" data-astro-cid-mluvns3u> <h2 class="text-2xl font-bold mb-4 text-gray-800" data-astro-cid-mluvns3u>\u26A1 Quick Actions</h2> <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4" data-astro-cid-mluvns3u> <button onclick="quickDemo('popular-datasets')" class="p-4 bg-indigo-50 hover:bg-indigo-100 rounded-lg text-center transition-colors" data-astro-cid-mluvns3u> <div class="text-2xl mb-2" data-astro-cid-mluvns3u>\u{1F4CA}</div> <div class="font-semibold text-indigo-800" data-astro-cid-mluvns3u>Popular Datasets</div> </button> <button onclick="quickDemo('ai-news')" class="p-4 bg-green-50 hover:bg-green-100 rounded-lg text-center transition-colors" data-astro-cid-mluvns3u> <div class="text-2xl mb-2" data-astro-cid-mluvns3u>\u{1F4F0}</div> <div class="font-semibold text-green-800" data-astro-cid-mluvns3u>AI News</div> </button> <button onclick="quickDemo('ml-trends')" class="p-4 bg-orange-50 hover:bg-orange-100 rounded-lg text-center transition-colors" data-astro-cid-mluvns3u> <div class="text-2xl mb-2" data-astro-cid-mluvns3u>\u{1F4C8}</div> <div class="font-semibold text-orange-800" data-astro-cid-mluvns3u>ML Trends</div> </button> <button onclick="quickDemo('test-all')" class="p-4 bg-red-50 hover:bg-red-100 rounded-lg text-center transition-colors" data-astro-cid-mluvns3u> <div class="text-2xl mb-2" data-astro-cid-mluvns3u>\u{1F680}</div> <div class="font-semibold text-red-800" data-astro-cid-mluvns3u>Test All</div> </button> </div> </div> </div> <script type="module">
        ...
        async function testTavily() {
            ...
            contentDiv.innerHTML = '<div class="text-center py-4">\u{1F50D} Searching...</div>';
        ...
        async function testDeepSeekKaggle() {
            ...
            resultsDiv.classList.remove('hidden');
            contentDiv.innerHTML = '<div class="text-center py-4">\u{1F9E0} Analyzing...</div>';
        ...
        async function testConnections() {
            ...
            resultsDiv.classList.remove('hidden');
            contentDiv.innerHTML = '<div class="text-center py-4">\u{1F527} Testing connections...</div>';
