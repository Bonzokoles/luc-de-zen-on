...
<<<<<<< HEAD
import { e as createAstro, c as createComponent, b as renderScript, d as renderHead, a as renderTemplate } from '../chunks/astro/server_BDhFni3J.mjs';
...
âš ď¸Ź
</div> <div> <p class="text-gray-400 text-sm">Alerty BezpieczeĹ„stwa</p> <p class="text-xl font-bold text-yellow-400" id="alertCount">0</p> </div> </div> </div> <div class="bg-gray-800 rounded-lg p-6 border border-gray-700"> <div class="flex items-center gap-3"> <div class="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center">
đź’ľ
...
đźš€ Kontrola DeploymentĂłw
</h2> <div class="space-y-4"> <!-- Production Deploy --> <div class="bg-gray-700 rounded-lg p-4"> <div class="flex items-center justify-between mb-3"> <div> <h3 class="font-semibold text-green-400">Deploy Produkcyjny</h3> <p class="text-sm text-gray-400">WdroĹĽenie do Ĺ›rodowiska produkcyjnego</p> </div> <div class="text-right"> <p class="text-xs text-gray-500">Ostatni: 2h temu</p> <p class="text-xs text-green-400">Status: Sukces</p> </div> </div> <div class="flex gap-2 mb-3"> <button onclick="deployProduction()" class="bg-green-600 hover:bg-green-500 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2">
đźš€ Deploy Produkcja
