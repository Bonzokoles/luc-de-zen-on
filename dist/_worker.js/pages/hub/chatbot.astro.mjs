...
Interfejs chatbota i historia rozmĂłw.
</p> <div class="mt-8">[KOMPONENT CHATBOTA TUTAJ]</div> <div class="mt-8"> <a class="text-cyber-blue" href="/hub">â† PowrĂłt do HUB</a> </div> </section> ` })}`;
...
}, "Q:/mybonzo/mybonzo-github/src/pages/hub/chatbot.astro", void 0);

const $$file = "Q:/mybonzo/mybonzo-github/src/pages/hub/chatbot.astro";
