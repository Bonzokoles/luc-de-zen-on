...
</p> ${renderComponent($$result3, "CyberpunkButton", $$CyberpunkButton, { "text": "Zarz\u0105dzaj API", "variant": "outline", "size": "sm", "onclick": "openAPIManagement()" })} </div> </div> ` })} <!-- Recent Activity --> ${renderComponent($$result2, "GlassPanel", $$GlassPanel, { "title": "\u{1F550} Ostatnia aktywno\u015B\u0107", "variant": "default", "padding": "lg" }, { "default": ($$result3) => renderTemplate` <div style="max-height: 300px; overflow-y: auto;"> <div id="activityLog" style="space-y: 10px;"> <!-- Activity items will be loaded here --> </div> </div> <div style="text-align: center; margin-top: 20px;"> ${renderComponent($$result3, "CyberpunkButton", $$CyberpunkButton, { "text": "Od\u015Bwie\u017C logi", "variant": "outline", "size": "sm", "onclick": "refreshActivityLog()" })} </div> ` })} <!-- Logout --> <div style="text-align: center; margin-top: 30px;"> ${renderComponent($$result2, "CyberpunkButton", $$CyberpunkButton, { "text": "\u{1F6AA} Wyloguj si\u0119", "variant": "danger", "size": "md", "onclick": "logout()" })} </div> </div> ${renderScript($$result2, "Q:/mybonzo/luc-de-zen-on/src/pages/admin/login.astro?astro&type=script&index=0&lang.ts")} ` })}`;
