...
</div> </button> <button class="quick-query-btn text-left" onclick="setQuery(exampleQueries.aggregate)" data-astro-cid-kywjq26w> <div class="font-semibold text-cyan-400" data-astro-cid-kywjq26w>📈 Agregacja danych</div> <div class="text-sm text-gray-300" data-astro-cid-kywjq26w>COUNT, SUM, AVG, GROUP BY</div> </button> <button class="quick-query-btn text-left" onclick="setQuery(exampleQueries.join)" data-astro-cid-kywjq26w> <div class="font-semibold text-cyan-400" data-astro-cid-kywjq26w>🔗 JOIN tabeli</div> <div class="text-sm text-gray-300" data-astro-cid-kywjq26w>LEFT JOIN, INNER JOIN</div> </button> <button class="quick-query-btn text-left" onclick="setQuery(exampleQueries.analytics)" data-astro-cid-kywjq26w> <div class="font-semibold text-cyan-400" data-astro-cid-kywjq26w>🧮 Analityka</div> <div class="text-sm text-gray-300" data-astro-cid-kywjq26w>
