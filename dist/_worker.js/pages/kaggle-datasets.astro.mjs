...
Wyniki wyszukiwania
</h3> <p id="resultsInfo" class="text-gray-400 text-sm" data-astro-cid-3dzqupyy></p> </div> <div class="flex gap-2" data-astro-cid-3dzqupyy> <button data-action="export-results" class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded text-sm" data-astro-cid-3dzqupyy>
Export CSV
</button> <button data-action="view-favorites" class="px-3 py-1 bg-purple-600 hover:bg-purple-700 text-white rounded text-sm" data-astro-cid-3dzqupyy>
Ulubione
</button> </div> </div> <!-- Results Grid --> <div id="resultsGrid" class="results-grid p-4" data-astro-cid-3dzqupyy> <!-- Results will be populated here --> </div> <!-- Pagination --> <div id="paginationSection" class="pagination-section hidden border-t border-edge p-4" data-astro-cid-3dzqupyy> <div class="flex items-center justify-between" data-astro-cid-3dzqupyy> <button id="prevPage" data-action="prev-page" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded disabled:opacity-50" data-astro-cid-3dzqupyy>
← Poprzednia
</button> <span id="pageInfo" class="text-primary-foreground" data-astro-cid-3dzqupyy></span> <button id="nextPage" data-action="next-page" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded disabled:opacity-50" data-astro-cid-3dzqupyy>
Następna →
...
</h3> <div class="grid grid-cols-2 md:grid-cols-4 gap-3" data-astro-cid-3dzqupyy> <button class="quick-search-btn" data-action="quick-search" data-query="machine learning" data-astro-cid-3dzqupyy>
🤖 Machine Learning
</button> <button class="quick-search-btn" data-action="quick-search" data-query="image classification" data-astro-cid-3dzqupyy>
🖼️ Klasyfikacja obrazów
</button> <button class="quick-search-btn" data-action="quick-search" data-query="nlp natural language" data-astro-cid-3dzqupyy>
💬 NLP
</button> <button class="quick-search-btn" data-action="quick-search" data-query="covid coronavirus" data-astro-cid-3dzqupyy>
🦠 COVID-19
</button> <button class="quick-search-btn" data-action="quick-search" data-query="stock market finance" data-astro-cid-3dzqupyy>
📈 Finanse
</button> <button class="quick-search-btn" data-action="quick-search" data-query="climate weather" data-astro-cid-3dzqupyy>
🌡️ Klimat
</button> <button class="quick-search-btn" data-action="quick-search" data-query="house prices real estate" data-astro-cid-3dzqupyy>
🏠 Nieruchomości
</button> <button class="quick-search-btn" data-action="quick-search" data-query="sports football soccer" data-astro-cid-3dzqupyy>
⚽ Sport
