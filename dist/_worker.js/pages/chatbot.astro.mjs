...
Inteligentny asystent AI do rozmĂłw, odpowiadania na pytania i pomocy w
          zadaniach
...
đź’» Programowanie
</button> <button class="quick-action-btn" onclick="askQuestion('PrzetĹ‚umacz ten tekst na angielski')" data-astro-cid-cpe23hkd>
đźŚ TĹ‚umaczenie
</button> <button class="quick-action-btn" onclick="askQuestion('Napisz kreatywnÄ… historiÄ™ o kosmosie')" data-astro-cid-cpe23hkd>
âśŤď¸Ź Pisanie
</button> <button class="quick-action-btn" onclick="askQuestion('WyjaĹ›nij mi podstawy uczenia maszynowego')" data-astro-cid-cpe23hkd>
đź§  Nauka
</button> <button class="quick-action-btn" onclick="askQuestion('PomĂłĹĽ mi z matematykÄ…')" data-astro-cid-cpe23hkd>
đź”˘ Matematyka
</button> <button class="quick-action-btn" onclick="askQuestion('StwĂłrz plan diety')" data-astro-cid-cpe23hkd>
đźĄ— Zdrowie
</button> <button class="quick-action-btn" onclick="askQuestion('DoradĹş mi ksiÄ…ĹĽkÄ™ do czytania')" data-astro-cid-cpe23hkd>
đź“š KsiÄ…ĹĽki
