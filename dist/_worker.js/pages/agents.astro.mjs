...
Funkcje: Chat, TĹ‚umaczenia, Lokalne zadania
...
đź”§ StwĂłrz Nowego Agenta
</h2> <p class="text-gray-300 mb-6">
MoĹĽesz utworzyÄ‡ wĹ‚asnego agenta z konfigurowalnymi funkcjami
</p> <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> <div> <label class="block text-sm font-medium text-gray-300 mb-2">Nazwa agenta</label> <input type="text" id="agent-name" placeholder="np. MĂłjBot" class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-white focus:border-yellow-400 focus:outline-none"> </div> <div> <label class="block text-sm font-medium text-gray-300 mb-2">Model AI</label> <select id="agent-model" class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-white focus:border-yellow-400 focus:outline-none"> <option value="@cf/meta/llama-3.1-8b-instruct">Llama 3.1 8B</option> <option value="@cf/huggingface/bielik-7b-instruct-v0.1">Bielik 7B</option> <option value="@cf/google/gemma-3-12b-it">Gemma 3 12B</option> </select> </div> <div class="md:col-span-2"> <label class="block text-sm font-medium text-gray-300 mb-2">Opis agenta</label> <textarea id="agent-description" placeholder="Opisz co robi twĂłj agent..." class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-white focus:border-yellow-400 focus:outline-none h-24"></textarea> </div> <div class="md:col-span-2"> <label class="block text-sm font-medium text-gray-300 mb-2">Funkcje agenta</label> <div class="grid grid-cols-2 md:grid-cols-4 gap-2"> <label class="flex items-center space-x-2"> <input type="checkbox" value="chat" class="text-yellow-400"> <span class="text-sm">đź’¬ Chat</span> </label> <label class="flex items-center space-x-2"> <input type="checkbox" value="images" class="text-yellow-400"> <span class="text-sm">đź–Ľď¸Ź Obrazy</span> </label> <label class="flex items-center space-x-2"> <input type="checkbox" value="tasks" class="text-yellow-400"> <span class="text-sm">âšˇ Zadania</span> </label> <label class="flex items-center space-x-2"> <input type="checkbox" value="analysis" class="text-yellow-400"> <span class="text-sm">đź”Ť Analiza</span> </label> </div> </div> <div class="md:col-span-2"> <button onclick="createAgent()" class="bg-gradient-to-r from-yellow-500 to-orange-500 text-white px-6 py-3 rounded hover:opacity-80 transition-opacity">
StwĂłrz Agenta
...
đź“Š Status Systemu
</h3> <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="system-status"> <div class="text-center"> <div class="text-2xl text-green-400" id="active-agents">4</div> <div class="text-sm text-gray-400">Aktywne Agenty</div> </div> <div class="text-center"> <div class="text-2xl text-blue-400" id="total-messages">0</div> <div class="text-sm text-gray-400">WiadomoĹ›ci</div> </div> <div class="text-center"> <div class="text-2xl text-purple-400" id="images-generated">0</div> <div class="text-sm text-gray-400">Wygenerowane Obrazy</div> </div> <div class="text-center"> <div class="text-2xl text-yellow-400" id="tasks-completed">0</div> <div class="text-sm text-gray-400">UkoĹ„czone Zadania</div> </div> </div> </div> </section> </main> ${renderScript($$result2, "Q:/mybonzo/luc-de-zen-on/src/pages/agents/index.astro?astro&type=script&index=0&lang.ts")} ` })}`;
