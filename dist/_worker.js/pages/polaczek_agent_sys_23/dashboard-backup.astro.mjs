...
Ĺadowanie agentĂłw...
</div> </div> </div> </div> </div> </section> <div class="text-sm opacity-90">Aktywne Agenty</div> <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg p-4"> <div class="text-white"> <div class="text-2xl font-bold" id="total-agents">0</div> <div class="text-sm opacity-90">ĹÄ…cznie AgentĂłw</div> </div> </div> <div class="bg-gradient-to-br from-orange-600 to-orange-700 rounded-lg p-4"> <div class="text-white"> <div class="text-2xl font-bold" id="pending-tasks">0</div> <div class="text-sm opacity-90">OczekujÄ…ce Zadania</div> </div> </div> <div class="bg-gradient-to-br from-purple-600 to-purple-700 rounded-lg p-4"> <div class="text-white"> <div class="text-2xl font-bold" id="system-health">100%</div> <div class="text-sm opacity-90">Zdrowie Systemu</div> </div> </div> </main>  ${renderComponent($$result2, "GlassPanel", GlassPanel, { "class": "mb-8" }, { "default": async ($$result3) => renderTemplate` <div class="p-6"> <div class="flex justify-between items-center mb-4"> <h2 class="text-2xl font-bold text-white">đź¤– Aktywne Agenty</h2> <button id="refresh-agents" class="px-4 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg text-white transition-colors">
đź”„ OdĹ›wieĹĽ
</button> </div> <div id="agents-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"> <!-- Agent cards will be dynamically loaded here --> </div> </div> ` })}  ${renderComponent($$result2, "GlassPanel", GlassPanel, {}, { "default": async ($$result3) => renderTemplate` <div class="p-6"> <h2 class="text-2xl font-bold text-white mb-4">âšˇ Szybkie Akcje</h2> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4"> ${renderComponent($$result3, "CyberpunkButton", CyberpunkButton, { "href": "/POLACZEK_AGENT_SYS_23/monitor", "class": "bg-red-600 hover:bg-red-500" }, { "default": async ($$result4) => renderTemplate`
đź“ Monitoring Systemu
