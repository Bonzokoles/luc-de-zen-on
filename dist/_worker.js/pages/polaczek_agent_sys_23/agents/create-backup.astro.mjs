...
import { c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead, b as renderScript } from '../../../chunks/vendor_QZhDtzeH.mjs';
...
🛠️ KREATOR AGENTÓW - Stwórz<br data-astro-cid-ruqxmpje>
...
Nazwa Agenta *
</label> <input type="text" name="name" id="agent-name" placeholder="np. Polaczek_Custom_1" class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500" required data-astro-cid-ruqxmpje> <p class="text-xs text-gray-500 mt-1" data-astro-cid-ruqxmpje>Nazwa musi być unikalna i nie zawierać spacji</p> </div> <div data-astro-cid-ruqxmpje> <label class="block text-sm font-medium text-gray-300 mb-2" data-astro-cid-ruqxmpje>
Typ Agenta *
</label> <select name="type" id="agent-type" class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-cyan-500" required data-astro-cid-ruqxmpje> <option value="" data-astro-cid-ruqxmpje>Wybierz typ agenta</option> <option value="chatbot" data-astro-cid-ruqxmpje>🤖 Chatbot - Asystent konwersacyjny</option> <option value="translator" data-astro-cid-ruqxmpje>🌐 Translator - Tłumacz języków</option> <option value="searcher" data-astro-cid-ruqxmpje>🔍 Searcher - Agent wyszukujący</option> <option value="monitor" data-astro-cid-ruqxmpje>📊 Monitor - Agent monitorujący</option> <option value="artist" data-astro-cid-ruqxmpje>🎨 Artist - Generator grafik</option> <option value="analyst" data-astro-cid-ruqxmpje>📈 Analyst - Analityk danych</option> <option value="writer" data-astro-cid-ruqxmpje>✍️ Writer - Generator treści</option> <option value="coder" data-astro-cid-ruqxmpje>💻 Coder - Asystent programisty</option> <option value="scheduler" data-astro-cid-ruqxmpje>⏰ Scheduler - Zarządca zadań</option> <option value="custom" data-astro-cid-ruqxmpje>🔧 Custom - Niestandardowy</option> </select> </div> </div> <div data-astro-cid-ruqxmpje> <label class="block text-sm font-medium text-gray-300 mb-2" data-astro-cid-ruqxmpje>
Opis Agenta *
</label> <textarea name="description" id="agent-description" rows="3" placeholder="Opisz funkcjonalność i przeznaczenie agenta..." class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500" required data-astro-cid-ruqxmpje></textarea> </div> <!-- Configuration --> <div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-astro-cid-ruqxmpje> <div data-astro-cid-ruqxmpje> <label class="block text-sm font-medium text-gray-300 mb-2" data-astro-cid-ruqxmpje>
Port
</label> <input type="number" name="port" id="agent-port" placeholder="3011" min="3000" max="9999" class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500" data-astro-cid-ruqxmpje> <p class="text-xs text-gray-500 mt-1" data-astro-cid-ruqxmpje>Port dla WebSocket serwera (domyślnie: auto)</p> </div> <div data-astro-cid-ruqxmpje> <label class="block text-sm font-medium text-gray-300 mb-2" data-astro-cid-ruqxmpje>
Język
</label> <select name="language" id="agent-language" class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-cyan-500" data-astro-cid-ruqxmpje> <option value="python" data-astro-cid-ruqxmpje>🐍 Python</option> <option value="javascript" data-astro-cid-ruqxmpje>🟨 JavaScript/Node.js</option> <option value="typescript" data-astro-cid-ruqxmpje>🔷 TypeScript</option> </select> </div> </div> <!-- Capabilities --> <div data-astro-cid-ruqxmpje> <label class="block text-sm font-medium text-gray-300 mb-4" data-astro-cid-ruqxmpje>
Możliwości Agenta
</label> <div class="grid grid-cols-2 md:grid-cols-3 gap-3" data-astro-cid-ruqxmpje> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="text_processing" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Przetwarzanie tekstu</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="web_search" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Wyszukiwanie web</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="api_integration" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Integracja API</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="file_processing" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Przetwarzanie plików</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="image_generation" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Generowanie obrazów</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="data_analysis" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Analiza danych</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="real_time_monitoring" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Monitoring real-time</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="email_notifications" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Powiadomienia email</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="capabilities" value="scheduling" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Planowanie zadań</span> </label> </div> </div> <!-- AI Model Configuration --> <div id="ai-config" class="space-y-4" data-astro-cid-ruqxmpje> <h3 class="text-lg font-semibold text-white" data-astro-cid-ruqxmpje>Konfiguracja AI</h3> <div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-astro-cid-ruqxmpje> <div data-astro-cid-ruqxmpje> <label class="block text-sm font-medium text-gray-300 mb-2" data-astro-cid-ruqxmpje>
Model AI
...
System Prompt
</label> <textarea name="system_prompt" id="system-prompt" rows="4" placeholder="Jesteś pomocnym asystentem AI. Twoje zadanie to..." class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500" data-astro-cid-ruqxmpje></textarea> </div> </div> <!-- Advanced Settings --> <div class="border-t border-gray-600 pt-6" data-astro-cid-ruqxmpje> <details class="group" data-astro-cid-ruqxmpje> <summary class="cursor-pointer text-lg font-semibold text-white group-open:text-cyan-400" data-astro-cid-ruqxmpje>
...
Timeout (sekundy)
</label> <input type="number" name="timeout" placeholder="30" min="5" max="300" class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500" data-astro-cid-ruqxmpje> </div> </div> <div class="space-y-2" data-astro-cid-ruqxmpje> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="auto_start" class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Automatyczne uruchamianie przy starcie systemu</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="logging_enabled" checked class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Włącz logowanie</span> </label> <label class="flex items-center space-x-2" data-astro-cid-ruqxmpje> <input type="checkbox" name="monitoring_enabled" checked class="form-checkbox text-cyan-600" data-astro-cid-ruqxmpje> <span class="text-sm text-gray-300" data-astro-cid-ruqxmpje>Włącz monitoring wydajności</span> </label> </div> </div> </details> </div> <!-- Form Actions --> <div class="flex justify-end space-x-4 pt-6 border-t border-gray-600" data-astro-cid-ruqxmpje> <button type="button" id="preview-agent" class="px-6 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg text-white font-medium transition-colors" data-astro-cid-ruqxmpje>
