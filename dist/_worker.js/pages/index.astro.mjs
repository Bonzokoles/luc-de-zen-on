...
function GoogleVoiceAgent($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<div class="voice-control-panel floating-widget-template svelte-53d72o"><div class="voice-header svelte-53d72o"><div class="voice-title-section svelte-53d72o"><div class="voice-icon svelte-53d72o">🎤</div> <div class="voice-title svelte-53d72o">GOOGLE VOICE</div></div> <div class="voice-status svelte-53d72o"${attr_style(`color: ${stringify(getStatusColor())};`)}>${escape_html(getStatusText())}</div></div> <div class="voice-content svelte-53d72o">`);

		{
			$$renderer.push('<!--[-->');
			$$renderer.push(`<div class="voice-error svelte-53d72o"><p class="svelte-53d72o">Przeglądarka nie obsługuje rozpoznawania mowy</p> <small class="svelte-53d72o">Użyj Chrome, Edge lub Safari</small></div>`);
		}

		$$renderer.push(`<!--]--></div></div> <button class="floating-agents-toggle svelte-53d72o" title="Toggle Google Agents Panel">🤖</button> `);
...
</button> <div id="polaczekWidget" class="floating-widget" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "AiHelpAssistant", AiHelpAssistant, { "client:load": true, "client:component-hydration": "load", "client:component-path": "Q:/mybonzo/luc-de-zen-on/src/components/AiHelpAssistant.svelte", "client:component-export": "default", "data-astro-cid-j7pv25f6": true })} </div> </div> <div class="floating-widget-container" data-astro-cid-j7pv25f6> <button onclick="toggleGoogleVoice()" class="right-btn" id="googleVoiceBtn" title="Google Voice Agent do sterowania głosem" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Icon", $$Icon, { "name": "lucide:mic", "data-astro-cid-j7pv25f6": true })} GOOGLE VOICE
</button> <div id="googleVoiceWidget" class="floating-widget" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "GoogleVoiceAgent", GoogleVoiceAgent, { "client:load": true, "client:component-hydration": "load", "client:component-path": "Q:/mybonzo/luc-de-zen-on/src/components/GoogleVoiceAgent.svelte", "client:component-export": "default", "data-astro-cid-j7pv25f6": true })} </div> </div> <button onclick="openMainChat()" class="right-btn" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Icon", $$Icon, { "name": "lucide:message-circle", "data-astro-cid-j7pv25f6": true })} MAIN CHAT </button> <button onclick="openRefresh()" class="right-btn" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Icon", $$Icon, { "name": "lucide:refresh-cw", "data-astro-cid-j7pv25f6": true })} REFRESH </button> <button onclick="openFolder()" class="right-btn" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Icon", $$Icon, { "name": "lucide:folder", "data-astro-cid-j7pv25f6": true })} FOLDER </button> <button onclick="openClose()" class="right-btn" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "Icon", $$Icon, { "name": "lucide:x", "data-astro-cid-j7pv25f6": true })} CLOSE </button> </div>  <section class="border border-edge relative" data-astro-cid-j7pv25f6> <div class="absolute left-0 right-0 h-full" data-astro-cid-j7pv25f6> <!-- Inner vertical lines --> <div class="absolute left-[calc(50vw+400px)] top-0 bottom-0 w-px bg-edge" data-astro-cid-j7pv25f6></div> <div class="absolute right-[calc(50vw-400px)] top-0 bottom-0 w-px bg-edge" data-astro-cid-j7pv25f6></div> <!-- Outer vertical lines --> <div class="absolute left-[calc(50vw+600px)] top-0 bottom-0 w-px bg-edge" data-astro-cid-j7pv25f6></div> <div class="absolute right-[calc(50vw-600px)] top-0 bottom-0 w-px bg-edge" data-astro-cid-j7pv25f6></div> </div> <div class="max-w-6xl mx-auto" data-astro-cid-j7pv25f6> <div class="py-1" data-astro-cid-j7pv25f6></div> </div> </section>  <section class="border border-edge relative" data-astro-cid-j7pv25f6> <div class="absolute left-0 right-0 h-full" data-astro-cid-j7pv25f6> <!-- Inner vertical lines --> <div class="absolute left-[calc(50vw+400px)] top-0 bottom-0 w-px bg-edge" data-astro-cid-j7pv25f6></div> <div class="absolute right-[calc(50vw-400px)] top-0 bottom-0 w-px bg-edge" data-astro-cid-j7pv25f6></div> <!-- Outer vertical lines --> <div class="absolute left-[calc(50vw+600px)] top-0 bottom-0 w-px bg-edge" data-astro-cid-j7pv25f6></div> <div class="absolute right-[calc(50vw-600px)] top-0 bottom-0 w-px bg-edge" data-astro-cid-j7pv25f6></div> </div> <div class="max-w-6xl mx-auto" data-astro-cid-j7pv25f6> <div class="flex flex-row justify-between items-center py-16 px-8" data-astro-cid-j7pv25f6> <!-- Left corner - O_MNIE content --> <div class="max-w-xs text-left" data-astro-cid-j7pv25f6> <div class="text-edge text-sm italic" style="
