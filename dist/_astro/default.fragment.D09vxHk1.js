import{d as e}from"./decorators.serialization.DTWIlLMH.js";import"./logDepthDeclaration.CHF0qKNj.js";import"./helperFunctions.BBD6oZAl.js";import"./scene.C9ljXyY7.js";import"./fogFragment.D5dYZ8g-.js";import"./math.vector.C8FsJn6B.js";import"./math.color.BvxHr_bk.js";import"./preload-helper.BlTxHScW.js";import"./meshUboDeclaration.udh3qWt4.js";import"./tools.kgQOdK5j.js";import"./instantiationTools.DpJ04vA6.js";import"./smartArray.BsIpkRz3.js";import"./light.Tpw1S7gS.js";import"./node.B7U3vf9R.js";import"./postProcess.BhJOrjOy.js";import"./texture.DcuyhkEj.js";import"./baseTexture.xJCKUhPX.js";import"./math.size.F3xmSqZc.js";import"./math.plane.DogzNArm.js";import"./engine.Bhq7AZzW.js";import"./math.axis.BWIUWoG3.js";import"./math.path.Rz-CSHk9.js";import"./math.viewport.CgkTt1RS.js";import"./camera.DMMowNsy.js";import"./math.frustum.0quBJc8n.js";const o="decalFragmentDeclaration",A=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=A);const t="defaultFragmentDeclaration",x=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=x);const r="prePassDeclaration",P=`#ifdef PREPASS
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=N);const s="clusteredLightingFunctions",M=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};ClusteredLight getClusteredLight(sampler2D lightDataTexture,int index) {return ClusteredLight(
...
return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=O);const c="shadowsFragmentFunctions",y=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=y);const h="samplerFragmentDeclaration",b=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=b);const v="fresnelFunction",_=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=_);const u="reflectionFunction",U=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=z);const S="bumpFragmentFunctions",G=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=G);const C="bumpFragment",V=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=V);const E="decalFragment",B=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=B);const D="depthPrePass",k=`#ifdef DEPTHPREPASS
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Z);const i="defaultPixelShader",w=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=w);const Ee={name:i,shader:w};export{Ee as defaultPixelShader};
