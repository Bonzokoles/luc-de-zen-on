...
$rollbackCmd1 = 'Copy-Item "src\pages\api\bigquery.ts.backup" "src\pages\api\bigquery.ts" -Force'
$rollbackCmd2 = 'Copy-Item "src\pages\api\get-recommendations.ts.backup" "src\pages\api\get-recommendations.ts" -Force'
Write-Host "   $rollbackCmd1" -ForegroundColor Gray
Write-Host "   $rollbackCmd2" -ForegroundColor Gray